...
export const defaultClubData = {
  ...
  '48_2C_P4': {
    name: '48° 2 Clubs Full (P4) - 90m carry',
  ...
  '52_2C_P4': {
    name: '52° 2 Clubs Full (P4) - 85m carry',
    baseline: { carry: 85, total: 87 },
  ...
  '56_2C_P4': {
    name: '56° 2 Clubs Full (P4) - 80m carry',
  ...
  '56_JIM_P3': {
    name: '56° JIM Vertical (P3) - 70m carry',
  ...
  '52_JIM_P3': {
    name: '52° JIM Vertical (P3) - 70m carry',
    baseline: { carry: 70, total: 73 },
    calm17: { carry: 70, total: 73 },
    headwind18: { carry: 66, total: 69 },
    tailwind18: { carry: 74, total: 77 },
  ...
  '48_2C_P2': {
    name: '48° 2 Clubs Parallel (P2) - 40m carry',
  ...
  '52_1C_P2': {
    name: '52° 1 Club Parallel (P2) - 53m carry',
  ...
  '52_2C_P2': {
    name: '52° 2 Clubs Parallel (P2) - 67m carry',
  ...
  '56_2C_P2': {
    name: '56° 2 Clubs Parallel (P2) - 45m carry',
